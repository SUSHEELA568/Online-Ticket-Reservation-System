	...
	<div class="col-md-10">
		<div class="panel panel-danger">
			<div class="panel-heading">
				<h3 class="panel-title">BOOKING STARTS HERE</h3>
			</div>
				...
				<div class="row">
					...
					<div class="col-md-3">
						<div class="panel panel-success">
							<div class="panel-heading">
								<h3 class="panel-title">3. PASSENGER INFORMATION
					...
					<div class="col-md-3">
						<div class="panel panel-warning">
							<div class="panel-heading">
								<h3 class="panel-title">4. PAYMENT INFORMATION</h3>
							</div>
							<div class="panel-body">
								TOTAL PAYMENT
							</div>
...
<div class="container-fluid">
	...
	<div class="col-md-4">
		<div class="alert alert-danger">
			...
			<strong>Gentle Remainder!</strong> Please review your passenger information.
			You cannot change your booking once you proceed. 
		</div>
		<div class="panel panel-default">
			<div class="panel-body">
			 <h2>
			 	<center>PASSENGER INFORMATION</center>
			 </h2>
				<div class="container-fluid">
					<form class="form-horizontal" role="form" id="form-pass">
					  <div class="form-group">
					    ...
					    autofocus="" required="" autocomplete="off" maxlength="30" pattern="[a-zA-Z]+" required>
					  </div>
					  <div class="form-group">
					    <label for="">Contact:</label>
					    <input type="text" class="form-control" id="cont" placeholder="Enter Contact" required="" autocomplete="off" pattern="[7-9]{1}[0-9]{9}" required>
					  </div>
					  <div class="form-group">
					  	...
					  	<div class="panel-body">
					  		<div class="container-fluid">
					  			<div class="form-group">
								    ...
								    placeholder="Enter Fullname" required autocomplete="off" maxlength="30" pattern="[a-zA-z]+">
								  </div>

								  <div class="form-group">
								    <label for="">Age: (<?= $count; ?>):</label>
								    <input type="number" class="form-control" id="age<?php echo $i; ?>"
								    placeholder="Enter Age" required autocomplete="off" maxlength="3">
								  </div>
								  <div class="form-group">
