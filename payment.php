...
<nav class="navbar navbar-inverse">
  <div class="container-fluid">
    <div class="navbar-header">
      <a class="navbar-brand" href="#">Thank You for choosing and travelling with us.....</a>
    </div>
				...
				<div class="row">
					...
					<div class="col-md-3">
						<div class="panel panel-warning">
							<div class="panel-heading">
								<h3 class="panel-title">4. PAYMENT INFORMATION
		...
		<div class="panel panel-default">
			<div class="panel-body">
			 ...
			 <div class="panel panel-success">
			 	...
			 	<div class="panel-body">
			 		<strong>
			 			<b>Explore World - Passangers Booking Details</b>
			 			<h3>
			 			...
			 			<p>Departure Date: <?= $_SESSION['departure_date']; ?> @10:00AM</p>
			 		</strong>
			 			<i>Estimated Arrival Time: The Next Day @6:00PM</i><br />
			 			<strong>
			 ...
			 <div class="panel panel-success">
			 	...
			 	<strong>Contact Number:</strong> <?= $bookByInfo['book_contact']; ?><br />
