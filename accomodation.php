...
<nav class="navbar navbar-inverse">
  <div class="container-fluid">
    <div class="navbar-header">
      <a class="navbar-brand" href="#">SELECT YOUR TYPE OF ACCOMODATION</a>
    </div>
				...
				<div class="row">
					...
					<div class="col-md-3">
						<div class="panel panel-success">
							<div class="panel-heading">
								<h3 class="panel-title">3. PASSENGER INFORMATION</h3>
							</div>
							<div class="panel-body">
								PASSENGER DETAILS
							</div>
				...
				<div class="container-fluid">
					<form class="form-horizontal" role="form" id="form-acc">
				      ...
				      <div class="form-group">
					    ...
					    <input type="number" min="1" class="form-control" name="totalPass" plactreholder="Enter No of Passenger" autocomplete="off">
					  </div>
